...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
	<form method="get" action="${pageContext.servletContext.contextPath}/khachthue/timkiem.htm">
		<div class="ui grid" style="padding-left:10%; background-color: white; border-radius: 5px; max-width: 120%; margin-top: 17px;">
			...
			<div class="four wide column">
				<b></b>
				<button class="ui primary button" style="margin-top: 20px;">Tìmkiếm</button>
			</div>
		</div>
	</form>
